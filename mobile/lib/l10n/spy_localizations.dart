...
class SpyLocalizations {
  ...
  static const _strings = {
    'en': {
      ...
      'timerRange': 'Enter 5 to 30 minutes.',
      ...
      'blendIn': 'Blend in. Listen closely the agents. Stay alive.',
      ...
      'stay': 'Stay',
      'yes': 'Yes',
      'autoPaused': 'Mission auto-paused while the app was in background.',
      'spyCaught': 'Spy {name} is caught!',
    ...
    'tr': {
      ...
      'spies': 'Casuslar',
      'spiesHelperLocked':
          'Sahadaki ajan sayısının 5\'i geçmediği durumlarda yalnızca bir casus olabilir.',
      'spiesHelper': 'Sahada 5\'den fazla ajan varsa görevde 2 casus olabilir.',
      'missionTimer': 'Operasyon Süresi',
      'timerRange': 'Süre 5 ila 30 dakika arasında olmalıdır.',
      ...
      'atmosphericMusic': 'Atmosfere uygun müzik',
      'haptics': 'Titreşim',
      'vibrate': 'Geribildirimde titreşim',
      'highContrast': 'Yüksek Kontrast',
      'highContrastDesc': 'Kontrastı artırır',
      'language': 'Dil',
      'languageSubtitle': 'Türkçe / İngilizce',
      'credits': 'Emeği Geçenler',
      'designedBy': 'Tasarım ve geliştirme: Doğukan Şıhman',
      'thanks': 'Sevgili eşim Deniz’e özel teşekkürler.',
      'homeTagline':
          'Kimseye güvenme. Uyum sağla. Köstebeği avla.\n Ya da köstebek sensen saklan.',
      ...
      'blendIn': 'Uyum sağla. Ajanları dikkatlice dinle. Hayatta kal.',
      'noTimerShort': 'Süre yok',
      ...
      'continue': 'Devam Et',
      'mainMenu': 'Ana Menü',
      'backToSetup': 'Geri Dön',
      'leaveMission': 'Görevden Çıkılsın mı?',
      'returnToMenu': 'Ana menüye dönmek istediğine emin misin?',
      'stay': 'Kal',
      'yes': 'Evet',
      'autoPaused': 'Uygulama arka plandayken görev otomatik duraklatıldı.',
      'spyCaught': 'Casus {name} yakalandı!',
      'emergencyMeeting': 'Acil toplantı',
      'cancel': 'Vazgeç',
      'eliminate': 'Ele',
      'timerPaused': 'Oylamada süre durduruldu',
