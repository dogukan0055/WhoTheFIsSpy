    ...
    <Layout className="justify-center space-y-12">
      ...
      <div className="text-center space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <h1 className="text-5xl font-black font-mono tracking-tighter text-foreground">
          WHO THE <span className="text-primary italic">F***</span>
          <br />
          IS SPY?
        </h1>
        <p className="text-muted-foreground max-w-xs mx-auto">
          Deception, deduction, and betrayal. Can you find the impostor among
          us?
        </p>
      </div>
            ...
            <div className="space-y-4 text-sm">
              <section>
                ...
                <ul className="list-disc pl-4 space-y-1 text-muted-foreground">
                  <li>
                    <strong className="text-blue-400">Civilians:</strong> Find
                    the Spy. Ask questions to prove you know the location.
                  </li>
                  <li>
                    <strong className="text-red-400">Spy:</strong> Blend in.
                    Figure out the location. Don't get caught.
                  </li>
                </ul>
              </section>
              <section>
              ...
              <section>
                ...
                <ul className="list-disc pl-4 space-y-1 text-muted-foreground">
                  <li>
                    <strong>Spy Wins if:</strong> A civilian is eliminated
                    (unless there are multiple spies), or if spies outnumber
                    civilians, or if timer runs out.
                  </li>
                  <li>
                    <strong>Civilians Win if:</strong> All spies are eliminated.
                  </li>
                </ul>
              </section>
            </div>
