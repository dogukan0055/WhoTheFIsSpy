...
export const LOCATION_LABELS: Record<string, { en: string; tr: string }> = {
  ...
  [toLocationKey("Cinema")]: { en: "Cinema", tr: "Sinema" },
  ...
  [toLocationKey("Cruise Ship")]: { en: "Cruise Ship", tr: "Tatil Gemisi" },
  ...
  [toLocationKey("Construction Site")]: {
  ...
  // Nightlife
  [toLocationKey("Karaoke Lounge")]: {
    en: "Karaoke Lounge",
    tr: "Karaoke Salonu",
  },
  [toLocationKey("Rooftop Bar")]: { en: "Rooftop Bar", tr: "Çatı Bar" },
  [toLocationKey("Jazz Club")]: { en: "Jazz Club", tr: "Caz Kulübü" },
  [toLocationKey("Underground Rave")]: {
    en: "Underground Rave",
    tr: "Yeraltı Parti",
  },
  [toLocationKey("VIP Casino Room")]: {
    en: "VIP Casino Room",
    tr: "VIP Kumar Salonu",
  },
  [toLocationKey("Late Night Diner")]: {
    en: "Late Night Diner",
    tr: "Gece Lokantası",
  },
  [toLocationKey("Speakeasy")]: { en: "Speakeasy", tr: "Gizli Bar" },
  [toLocationKey("Comedy Club")]: { en: "Comedy Club", tr: "Komedi Kulübü" },
  [toLocationKey("Botanical Rooftop")]: {
    en: "Botanical Rooftop",
    tr: "Botanik Teras",
  },
  [toLocationKey("Skybridge Bar")]: {
    en: "Skybridge Bar",
    tr: "Gökyüzü Köprüsü Barı",
  },

  // Transit
  [toLocationKey("Airport Terminal")]: {
    en: "Airport Terminal",
    tr: "Havalimanı Terminali",
  },
  [toLocationKey("Train Station")]: { en: "Train Station", tr: "Tren Garı" },
  [toLocationKey("Metro Platform")]: {
    en: "Metro Platform",
    tr: "Metro Peronu",
  },
  [toLocationKey("Harbor Dock")]: { en: "Harbor Dock", tr: "Liman İskelesi" },
  [toLocationKey("Highway Rest Stop")]: {
    en: "Highway Rest Stop",
    tr: "Otoyol Mola Tesisi",
  },
  [toLocationKey("Border Checkpoint")]: {
    en: "Border Checkpoint",
    tr: "Sınır Kapısı",
  },
  [toLocationKey("Subway Control Room")]: {
    en: "Subway Control Room",
    tr: "Metro Kontrol Odası",
  },
  [toLocationKey("Helipad")]: { en: "Helipad", tr: "Helikopter Pisti" },
  [toLocationKey("Spaceport Gate")]: {
    en: "Spaceport Gate",
